...
`kraken` se toma muy en serio la seguridad de este proyecto.
...
- Se corrigen vulnerabilidades en la rama `master` y en la última versión publicada.
...
Gracias por ayudar a que `kraken` sea seguro para todos.
